...
const bright = 2
export const red = rainbow(0, bright);
export const orange = rainbow(27, bright);
export const yellow = rainbow(54, bright);
export const green = rainbow(110, bright);
export const light_blue = rainbow(177, bright);
export const blue = rainbow(240, bright);
export const purple = rainbow(285, bright);
export const pink = rainbow(323, bright);
